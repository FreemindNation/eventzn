    ...
    <Card className="max-w-3xl mx-auto">
      ...
      <CardBody>
        <Form action={action} className="space-y-4">
          <Input isRequired label="Title" name="title" type="text" onChange={(e) => console.log("Title Input Value:", e.target.value)} onKeyDown={() => {}}/>
          ...
          <DatePicker isRequired label="Start Time" name="startTime" />
          {state.validationErrors?.startTime && (
            <p className="text-red-500 text-sm">{state.validationErrors.startTime[0]}</p>
          )}

          <DatePicker isRequired label="End Time" name="endTime" />
          ...
          <Input label="Image URL" name="imageUrl" type="url" onKeyDown={() => {}} />
